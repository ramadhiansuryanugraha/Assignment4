...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull CardView rootView, @NonNull CardView cardviewLayout,
      @NonNull TextView fulldescription, @NonNull ImageView imageView, @NonNull TextView textView1,
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      CardView cardviewLayout = (CardView) rootView;

      id = R.id.fulldescription;
      TextView fulldescription = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ListItemBinding((CardView) rootView, cardviewLayout, fulldescription, imageView,
          textView1, textView2);
    }
